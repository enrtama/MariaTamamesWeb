            ...
            <div id="SubMenu">
           	...
           	<div class="row" id="maincontent">
            	...
            	<div class="text slideToggle" id="projet-over">
                	...
                	<p><?php echo textOrtopedias1;?><p>
                	<p><?php echo textOrtopedias2;?><p>
                	<p><?php echo textOrtopedias3;?><p>
                    <p><?php echo textOrtopedias4;?><p>
        		</div><!-- fin.row -->
    		</div> <!-- /container -->   
            <p><img src="Images/Ortopedias/Campaign/1.JPG" alt="Ortopedias 1" border="0" height="auto" width="900"/></p>
            <p><img src="Images/Ortopedias/Campaign/2.JPG" alt="Ortopedias 2" border="0" height="auto" width="435"/>
            <img src="Images/Ortopedias/Campaign/4.JPG" alt="Ortopedias 3" border="0" height="auto" width="435" align="right"/></p>
            <p><img src="Images/Ortopedias/Campaign/5.JPG" alt="Ortopedias 4" border="0" height="auto" width="435"/>
            <img src="Images/Ortopedias/Campaign/6.JPG" alt="Ortopedias 5" border="0" height="auto" width="435" align="right"/></p>
        </div>
        <!-- fin capa texto -->
