        ...
        <div id="textLayer">
            ...
            <div id="SubMenu">
        		<table id="tableSubMenu">
                    <tr><td id="botonMenuSeleccionado"><a href="CollaborationsWoman?lang=<?php echo $language;?>"><?php echo element17;?></a></td>
                    <td><a href="CollaborationsMan?lang=<?php echo $language;?>"><?php echo element18;?></a></td></tr>
        		</table>
    		</div>   
            ...
            <div class="row" id="maincontent">
            	...
            	<div class="text slideToggle" id="projet-over" style="margin-left:1px;width:896px;">
                	...
                	<p><?php echo textColaboracion2;?><p>
                    <p><a href="http://www.jeanpaulknott.com" target="_blank">>www.jeanpaulknott.com<</a><p>
        		</div><!-- fin.row -->
    		</div> <!-- /container -->            
            <p><img src="Images/Colaboraciones/1.jpg" class="photoframe" alt="Colaboracion 1" border="0" height="auto" width="435"/>
            <img src="Images/Colaboraciones/2.jpg" class="photoframe" alt="Colaboracion 2" border="0" height="auto" width="435" align="right"/></p>

            <p><img src="Images/Colaboraciones/3.jpg" class="photoframe" alt="Colaboracion 3" border="0" height="auto" width="435"/>            
            <img src="Images/Colaboraciones/4.jpg" class="photoframe" alt="Colaboracion 4" border="0" height="auto" width="435" align="right"/></p>
        </div>
        <!-- fin capa texto -->
        <div id="footerLayer">
