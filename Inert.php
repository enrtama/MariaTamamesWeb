...
<div id="contentLayer">
    ...
    <div id="capaCentro">
        <div id="textLayer">
			...
			<p class="projectTitle"><a href="Inerte?lang=<?php echo $language;?>"><?php echo title5;?></a></p>
            ...
            <div class="row" id="maincontent">
            	...
            	<div class="text slideToggle" id="projet-over">
                	...
                	<p><?php echo textInerte1;?><p>
                	<p><?php echo textInerte2;?><p>
                    <p><?php echo textInerte3;?><p>
        		</div><!-- fin.row -->
    		</div> <!-- /container -->
            <p><img src="Images/Inerte/5.jpg" alt="Inerte 5" border="0" height="auto" width="900"/></p>
            <p><img src="Images/Inerte/6.jpg" alt="Inerte 6" border="0" height="auto" width="900"/></p>
            <p><img src="Images/Inerte/7.jpg" alt="Inerte 7" border="0" height="auto" width="900"/></p>            
            <p><img src="Images/Inerte/8.jpg" alt="Inerte 8" border="0" height="auto" width="900"/></p>
	    <p><img src="Images/Inerte/9.jpg" alt="Inerte 9" border="0" height="auto" width="900"/></p>            
        </div>
        <!-- fin capa texto -->
